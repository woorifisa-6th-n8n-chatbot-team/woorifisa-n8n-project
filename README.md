...
수업을 듣고도 뒤돌아서면 까먹는 학생들과, 학생들이 진짜 이해했는지 궁금한 강사님들을 위한  
**RAG(검색 증강 생성) 기반 학습 보조 솔루션**
...
### 💡 문제 인식: 교육 현장의 반복되는 고민

#### 학생 관점의 Pain Point
- 🤔 "3주 차에 배운 Docker 명령어가 기억 안 나는데, 자료 어디 있더라?"
- 📚 "Notion 강의자료가 너무 많아서 찾기 힘들어..."
- ⏰ "과제 마감일이 언제였지? Slack 올라간 공지 다시 찾아야 하나..."
- 🔍 "ChatGPT한테 물어봤는데 우리 수업이랑 다른 방식으로 알려줘서 혼란스러워"

#### 강사/운영진 관점의 Pain Point
- 😶 "다들 이해하셨죠?" → 침묵... (실제로는 모르는데 질문 못함)
- 📊 "어떤 주제를 어려워하는지 감이 안 잡혀. 학생들 반응이 보이지 않아"
- 🔄 "같은 질문을 여러 학생이 반복해서 하는데, 효율적으로 대응할 방법이 없을까?"
- 📈 "학습 성과를 객관적으로 측정하고 리포트할 수 있는 데이터가 없어"

---

### 🎯 솔루션: 맞춤형 학습 AI 어시스턴트

#### 학생에게는: 24/7 개인 TA(Teaching Assistant)

**✅ 상황별 맞춤 답변**
- "3주 차에 배운 Docker 명령어 알려줘" → 해당 주차 강의자료 + 동기들의 학습 블로그 기반 답변
- "오늘 수업 일정 뭐야?" → 실시간 스케줄 DB 연동으로 정확한 정보 제공
- "Spring Boot 설정 방법 다시 설명해줘" → 우리 과정에서 사용하는 방식 그대로 안내

**✅ 학습 효율 극대화**
- 🔗 관련 Notion 자료 자동 링크 제공
- 📝 동기들이 작성한 Velog/Tistory 학습 후기 참조
- 🎯 수업에서 실제로 다룬 내용 기반 설명 (범용 AI의 일반론 ❌)

#### 강사/운영진에게는: 데이터 기반 학습 관리 대시보드

**✅ 실시간 학습 현황 파악**
- 📊 질문 유형 분석: "Docker 관련 질문이 이번 주에 급증 → 보충 설명 필요"
- 🔥 핫토픽 감지: "Kubernetes 네트워킹을 많이 어려워하네 → 실습 시간 추가 편성"
- 📈 학습 카테고리별 통계: Java/Spring/Docker/AWS 등 주제별 관심도 추이

**✅ 객관적 성과 측정**
- 🎯 주간 학습 내용 기반 맞춤형 퀴즈 자동 생성
- 📧 질문 유형 분석, 학습 카테고리 통계 등이 포함된 주간 리포트 자동 발송
- 📊 **ELK Stack 기반 실시간 대시보드**: Kibana로 학습 데이터 시각화
